...
namespace ClientLibrairie
{
    public partial class FormLect : Form
    {
        ...
        private ServiceReference.Affiliate _affiliate;
        ...
        /// </summary>
        public class EmpruntXtd : ServiceReference.Emprunt
        {
            public EmpruntXtd() { }
        ...
        private void SetAffiliate()
        {
            ...
            lblBiblioPr.Text = "Bibliothèque principale :  " + _libraries.Find(l => l.Id == _affiliate.MainLibraryId).Name;
        ...
        {
            FormDetails formDetails = new FormDetails(_emprunts.Find(e => e.Id == IdEmprunt));
            formDetails.Show();
        }
        ...
        /// <summary>
        /// Appelle la méthode de clôture de l'emprunt.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btRestitution_Click(object sender, EventArgs e)
        {
            if (dgvEmprunts.SelectedRows != null)
            {
